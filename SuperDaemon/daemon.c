		...
		close(master_ptx); 
		  ...
		  setsid();
		   ...
		   tcgetattr(slave_ptx, &slave_orig_term_settings); 
			...
			//cfmakeraw(&slave_orig_term_settings);
		  // Set raw mode on the slave side of the PTY
		   /*
		  slave_orig_term_settings.c_oflag &= ~(ONLCR| OCRNL | ONLRET|ONLRET);
		  slave_orig_term_settings.c_oflag |= ONLRET | ONOCR;
		  
		  slave_orig_term_settings.c_iflag |= IGNCR;
		  slave_orig_term_settings.c_cc[VINTR] =1;
		  slave_orig_term_settings.c_cc[BRKINT] = 1;
		  */
